...
namespace IO.Swagger.Model
{
    ...
    public partial class Vote :  IEquatable<Vote>
    {
        ...
        /// <param name="CauseId">ID of the predictor variable (required).</param>
        /// <param name="EffectId">ID of effect variable (required).</param>
        /// <param name="Value">Value of Vote (required).</param>
        ...
        public Vote(int? Id = null, string ClientId = null, int? UserId = null, int? CauseId = null, int? EffectId = null, int? Value = null, DateTime? CreatedAt = null, DateTime? UpdatedAt = null)
        {
            // to ensure "ClientId" is required (not null)
            if (ClientId == null)
            {
                throw new InvalidDataException("ClientId is a required property for Vote and cannot be null");
            }
            else
            {
            ...
            if (UserId == null)
            {
                throw new InvalidDataException("UserId is a required property for Vote and cannot be null");
            }
            else
            {
                this.UserId = UserId;
            }
            // to ensure "CauseId" is required (not null)
            if (CauseId == null)
            {
                throw new InvalidDataException("CauseId is a required property for Vote and cannot be null");
            }
            else
            {
            ...
            if (EffectId == null)
            {
                throw new InvalidDataException("EffectId is a required property for Vote and cannot be null");
            }
            else
            {
            ...
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for Vote and cannot be null");
            }
            else
            {
                this.Value = Value;
