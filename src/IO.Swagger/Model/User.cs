...
namespace IO.Swagger.Model
{
    ...
    public partial class User :  IEquatable<User>
    {
        ...
        /// <param name="WpId">Wordpress user id (required).</param>
        /// <param name="DisplayName">User display name (required).</param>
        /// <param name="LoginName">User login name (required).</param>
        /// <param name="Email">User email (required).</param>
        /// <param name="Token">User token (required).</param>
        /// <param name="Administrator">Is user administrator (required).</param>
        public User(int? Id = null, int? WpId = null, string DisplayName = null, string LoginName = null, string Email = null, string Token = null, bool? Administrator = null)
        {
            ...
            // to ensure "WpId" is required (not null)
            if (WpId == null)
            {
                throw new InvalidDataException("WpId is a required property for User and cannot be null");
            }
            else
            {
                this.WpId = WpId;
            ...
            if (LoginName == null)
            {
                throw new InvalidDataException("LoginName is a required property for User and cannot be null");
            }
            else
            {
            ...
            if (Token == null)
            {
                throw new InvalidDataException("Token is a required property for User and cannot be null");
            }
            else
            {
                this.Token = Token;
            }
            // to ensure "Administrator" is required (not null)
            if (Administrator == null)
            {
                throw new InvalidDataException("Administrator is a required property for User and cannot be null");
            }
            else
            {
        ...
        public bool Equals(User other)
        {
            ...
            return 
                ...
                (
                    this.WpId == other.WpId ||
                    this.WpId != null &&
                    this.WpId.Equals(other.WpId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WpId != null)
                    hash = hash * 59 + this.WpId.GetHashCode();
