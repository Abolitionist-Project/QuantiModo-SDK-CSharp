...
namespace IO.Swagger.Model
{
    ...
    public partial class UnitCategory :  IEquatable<UnitCategory>
    {
        ...
        public UnitCategory(string Name = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for UnitCategory and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnitCategory);
        }
