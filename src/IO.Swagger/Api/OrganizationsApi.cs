    ...
    public partial class OrganizationsApi : IOrganizationsApi
    {
        ...
        public ApiResponse< UserTokenSuccessfulResponse > V1OrganizationsOrganizationIdUsersPostWithHttpInfo (int? organizationId, UserTokenRequest body, string accessToken = null)
        {
            ...
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling OrganizationsApi->V1OrganizationsOrganizationIdUsersPost");
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling OrganizationsApi->V1OrganizationsOrganizationIdUsersPost");
