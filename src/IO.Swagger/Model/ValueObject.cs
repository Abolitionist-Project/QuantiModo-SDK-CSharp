...
namespace IO.Swagger.Model
{
    ...
    public partial class ValueObject :  IEquatable<ValueObject>
    {
        ...
        /// Initializes a new instance of the <see cref="ValueObject" /> class.
        /// </summary>
        /// <param name="Timestamp">Timestamp for the measurement event in epoch time (unixtime) (required).</param>
        /// <param name="Value">Measurement value (required).</param>
        /// <param name="Note">Optional note to include with the measurement.</param>
        public ValueObject(long? Timestamp = null, double? Value = null, string Note = null)
        {
            // to ensure "Timestamp" is required (not null)
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for ValueObject and cannot be null");
            }
            else
            {
            ...
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for ValueObject and cannot be null");
            }
            else
            {
                this.Value = Value;
