...
namespace IO.Swagger.Model
{
    ...
    public partial class Credential :  IEquatable<Credential>
    {
        ...
        /// <param name="ConnectorId">The id for the connector data source from which the credential was obtained (required).</param>
        /// <param name="AttrKey">Attribute name such as token, userid, username, or password (required).</param>
        /// <param name="AttrValue">Encrypted value for the attribute specified (required).</param>
        ...
        public Credential(int? UserId = null, int? ConnectorId = null, string AttrKey = null, string AttrValue = null, DateTime? CreatedAt = null, DateTime? UpdatedAt = null)
        {
            // to ensure "ConnectorId" is required (not null)
            if (ConnectorId == null)
            {
                throw new InvalidDataException("ConnectorId is a required property for Credential and cannot be null");
            }
            else
            {
                this.ConnectorId = ConnectorId;
            }
            // to ensure "AttrKey" is required (not null)
            if (AttrKey == null)
            {
                throw new InvalidDataException("AttrKey is a required property for Credential and cannot be null");
            }
            else
            {
                this.AttrKey = AttrKey;
            }
            // to ensure "AttrValue" is required (not null)
            if (AttrValue == null)
            {
                throw new InvalidDataException("AttrValue is a required property for Credential and cannot be null");
            }
            else
            {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AttrKey != null)
                    hash = hash * 59 + this.AttrKey.GetHashCode();
                if (this.AttrValue != null)
                    hash = hash * 59 + this.AttrValue.GetHashCode();
