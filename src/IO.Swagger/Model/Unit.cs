...
namespace IO.Swagger.Model
{
    ...
    public partial class Unit :  IEquatable<Unit>
    {
        ...
        public enum CategoryEnum
        {
            ...
            /// <summary>
            /// Enum Miscellany for "Miscellany"
            /// </summary>
            [EnumMember(Value = "Miscellany")]
            Miscellany,
            
            /// <summary>
            /// Enum Pressure for "Pressure"
            /// </summary>
            [EnumMember(Value = "Pressure")]
            Pressure,
            
            /// <summary>
            /// Enum Proportion for "Proportion"
            /// </summary>
            ...
            /// <summary>
            /// Enum Temperature for "Temperature"
            /// </summary>
        ...
        /// <param name="AbbreviatedName">Unit abbreviation (required).</param>
        /// <param name="Category">Unit category (required).</param>
        /// <param name="MinimumValue">The smallest acceptable value for measurements using this unit.</param>
        /// <param name="MaximumValue">The largest acceptable value for measurements using this unit.</param>
        /// <param name="ConversionSteps">Conversion steps list (required).</param>
        public Unit(string Name = null, string AbbreviatedName = null, CategoryEnum? Category = null, double? MinimumValue = null, double? MaximumValue = null, List<ConversionStep> ConversionSteps = null)
        {
            ...
            // to ensure "AbbreviatedName" is required (not null)
            if (AbbreviatedName == null)
            {
                throw new InvalidDataException("AbbreviatedName is a required property for Unit and cannot be null");
            }
            else
            {
            ...
            if (Category == null)
            {
                throw new InvalidDataException("Category is a required property for Unit and cannot be null");
            }
            else
            {
                this.Category = Category;
            }
            // to ensure "ConversionSteps" is required (not null)
            if (ConversionSteps == null)
            {
                throw new InvalidDataException("ConversionSteps is a required property for Unit and cannot be null");
            }
            else
            {
        ...
        public bool Equals(Unit other)
        {
            ...
            return 
                ...
                (
                    this.ConversionSteps == other.ConversionSteps ||
                    this.ConversionSteps != null &&
                    this.ConversionSteps.SequenceEqual(other.ConversionSteps)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConversionSteps != null)
                    hash = hash * 59 + this.ConversionSteps.GetHashCode();
                return hash;
            }
        }
    }
