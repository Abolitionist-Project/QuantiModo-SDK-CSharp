...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectorInfo :  IEquatable<ConnectorInfo>
    {
        /// <summary>
        ...
        /// <param name="Error">Error message. Empty if connected. (required).</param>
        /// <param name="History">History (required).</param>
        public ConnectorInfo(int? Id = null, bool? Connected = null, string Error = null, List<ConnectorInfoHistoryItem> History = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for ConnectorInfo and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Connected == null)
            {
                throw new InvalidDataException("Connected is a required property for ConnectorInfo and cannot be null");
            }
            else
            {
            ...
            if (Error == null)
            {
                throw new InvalidDataException("Error is a required property for ConnectorInfo and cannot be null");
            }
            else
            {
                this.Error = Error;
            ...
            if (History == null)
            {
                throw new InvalidDataException("History is a required property for ConnectorInfo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConnectorInfo);
        }

        /// <summary>
        /// Returns true if ConnectorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of ConnectorInfo to be compared</param>
        /// <returns>Boolean</returns>
